...
class RunConfig:
    ...
    draft_guided: bool = False
    draft_max_depth: int = 1
    draft_branch_per_node: int = 2
    draft_max_nodes: int = 80
    ...
    def from_cli_args(cls, args) -> "RunConfig":
        return cls(
            ...
            draft_guided=args.draft_guided,
            draft_max_depth=args.draft_max_depth,
            draft_branch_per_node=args.draft_branch_per_node,
            draft_max_nodes=args.draft_max_nodes,
    ...
    def run_request_payload(self, corners_expr: str) -> Dict[str, object]:
        return {
            ...
            "draft_guided": self.draft_guided,
            "draft_max_depth": self.draft_max_depth,
            "draft_branch_per_node": self.draft_branch_per_node,
            "draft_max_nodes": self.draft_max_nodes,
            "out_path": self.out_path,
            "cp_graph_path": self.cp_graph_path,
